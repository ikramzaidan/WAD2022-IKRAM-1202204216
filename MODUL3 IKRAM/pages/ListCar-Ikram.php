    ...
    <body>
        <nav class="navbar navbar-dark bg-primary  navbar-expand-lg sticky-top" style="background-color: #e9ecef;">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <a href="/pages/Add-Ikram.php" class="btn btn-light bg-white">Add Car</a>
                </div>
            </div>
        </nav>
        ...
        <div class="toast show align-items-center text-bg-success border-0" role="alert" aria-live="assertive" aria-atomic="true">
            <div class="d-flex">
                ...
                <?php if($_SESSION['msg']=='is'):echo"Data berhasil ditambahkan.";elseif($_SESSION['msg']=='us'):echo"Data berhasil diperbarui.";endif;
                ?>
                </div>
